    ...
    return (
      <div id="add-form">
        ...
        <form className="form-view" id="add-question-form" onSubmit={this.submitQuestion}>
          <label>
            Question
            <input type="text" name="question" onChange={this.handleChange} placeholder="Question"/>
          </label>
          <label>
            Answer
            <input type="text" name="answer" onChange={this.handleChange} placeholder="Answar"/>
          </label>
          <label>
            Difficulty
